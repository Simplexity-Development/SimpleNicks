...
public enum Message {
    ...
    NICK_LOOKUP_HEADER("nick.lookup.header", "<prefix>Users with the name <yellow><value></yellow>: "),
    NICK_LOOKUP_USER("nick.lookup.user", "\n- <green><name></green> - Last Seen: <time></gray>"),
    ...
    ERROR_INVALID_NICK_LENGTH("error.invalid.nick-length", "<prefix><red>Nickname is too long, must be <= <value> characters stripped of formatting. Your nickname stripped is: <name>"),
    ERROR_INVALID_NICK_EMPTY("error.invalid.nick-empty", "<prefix><red>Nickname after parsing must actually contain characters. The nickname you provided was blank after parsing."),
    ...
    ERROR_INVALID_CONFIG_REGEX("error.invalid.config-regex", "<prefix><red>nickname-regex is null or malformed in file 'config.yml'. Please fix this"),
