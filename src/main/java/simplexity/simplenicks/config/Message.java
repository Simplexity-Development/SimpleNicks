...
public enum Message {
    ...
    ERROR_INVALID_NICK("error.invalid.nick", "Not a valid nickname, must follow regex: <regex>"),
    ERROR_INVALID_NICK_LENGTH("error.invalid.nick-length", "Nickname is too long, must be <= <value> characters stripped of formatting. Your nickname stripped is: <name>"),
